...
write.table(scaling_summary, 'autosomes_scaling_summary_keep_diag_202005.tsv', sep='\t', col.names = TRUE, row.names = FALSE, quote = FALSE)
...
pdf(file='autosomes_scaling1_202005.pdf', width = 10, height = 10)
p
dev.off()

pdf(file='autosomes_scaling2_202005.pdf', width = 10, height = 10)
q
dev.off()

pdf(file='autosomes_scaling_Z_vs_Sun1_202005.pdf', width = 10, height = 10)
s
dev.off()
